...
const SearchAndFilters: React.FC<SearchAndFiltersProps> = ({
  ...
  const hasActiveFilters = filters.category || filters.state || filters.discoveryPeriod;
    ...
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700 
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <select
          ...
          onChange={(e) => onFilterChange({
            ...filters,
            state: e.target.value as 'solid' | 'liquid' | 'gas' | 'unknown' || undefined
          })}
          className="px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 
                     rounded bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100
                     focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        <select
          ...
          onChange={(e) => onFilterChange({
            ...filters,
            discoveryPeriod: e.target.value as 'ancient' | 'medieval' | 'modern' | 'contemporary' || undefined
          })}
          className="px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 
                     rounded bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100
                     focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
